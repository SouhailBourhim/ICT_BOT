...
from models.base import ProcessedChunk, DocumentMetadata
from processors.interfaces import DocumentProcessorInterface
...
class DocumentProcessor(DocumentProcessorInterface):
    ...
    def preserve_formatting(self, chunk: str):
        ...
        from models.base import FormattedChunk, ContentType
